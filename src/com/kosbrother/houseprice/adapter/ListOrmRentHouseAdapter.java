...
public class ListOrmRentHouseAdapter extends BaseAdapter
{
	private final FavoriteActivity activity;
	private final ArrayList<OrmRentHouse> data;
	private static LayoutInflater inflater = null;
	private ImageLoader imageLoader;

	// private String mChannelTitle;

	public ListOrmRentHouseAdapter(FavoriteActivity a, ArrayList<OrmRentHouse> d)
	{
		activity = a;
		data = d;
